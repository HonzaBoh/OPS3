...
FILES=(
    "/books/news -rwxrwxr-x $MAIN_USER authors"
    "/books/fairyTales/rapunzel -rwxrwxr-x wilhelm grimms"
    "/books/fantasy/lotr -rwxr-xr-x tolkien authors"
    "/books/fantasy/unfinished -rwx------ tolkien"
)
